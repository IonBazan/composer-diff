...
class Table
{
    ...
    {
        $cleanLength = Helper::width(Helper::removeDecoration($this->output->getFormatter(), $row[$column]));
    ...
    private function getColumnWidth(int $column): int
    {
        ...
        foreach (array_merge([$this->headers], $this->rows) as $row) {
            $lengths[] = Helper::width(Helper::removeDecoration($this->output->getFormatter(), $row[$column]));
        }
