...
============
 ...
 - Uninstall [32m[a/package-4](https://example.com/r/a/package-4)[39m ([33m0.1.1[39m) [Compare](https://example.com/r/0.1.1){$package4License}
 - Uninstall [32ma/no-link-2[39m ([33m0.1.1[39m){$noLink2License}
...
============
 ...
 - Uninstall [a/package-4](https://example.com/r/a/package-4) (0.1.1) [Compare](https://example.com/r/0.1.1){$package4License}
 - Uninstall a/no-link-2 (0.1.1){$noLink2License}
...
============
 ...
 - Uninstall [32ma/package-4[39m ([33m0.1.1[39m){$package4License}
 - Uninstall [32ma/no-link-2[39m ([33m0.1.1[39m){$noLink2License}
...
============
 ...
 - Uninstall a/package-4 (0.1.1){$package4License}
 - Uninstall a/no-link-2 (0.1.1){$noLink2License}
