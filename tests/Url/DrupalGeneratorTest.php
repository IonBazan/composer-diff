...
class DrupalGeneratorTest extends GeneratorTest
{
    ...
    protected function getPackageWithSourceAndDist(string $name, string $version, ?string $distVersion, ?string $sourceUrl, ?string $sourceReference = null): PackageInterface
    {
